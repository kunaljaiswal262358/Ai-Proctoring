export const ExamsList = ({ exams, setActiveTab, handleDeleteExam, setNewExam, selectActiveTab, setUpdate }) => {
  return (
                ...
                exams.map((exam) => (
                  <tr key={exam._id}>
                    ...
                    <td className="px-4 py-3 text-sm font-medium">
                      <button className="text-blue-600 hover:text-blue-900 mr-2" onClick={() => {selectActiveTab("create-exam"); setNewExam(exam); setUpdate(true)}}>
                        Edit
                      </button>
                      <button 
